  ...
  <!-- Modal-->
    ...
    <section class="content"> 
      <div class="container-fluid">
        ...
        ?>
      <br/>
        <form crole="form" method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
            ...
            <div class="card card-warning" style="border: 2px solid #012F5C;">
              ...
              <div class="card-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" title='Your City' name='city' id='city' value="{{$p->city}}">
                </div>
                <br> 
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
