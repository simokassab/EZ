          ...
          <div class="row">
            <div class="col col-sm-6">
              <div class="form-group">
                 ...
                 <input type="text" class="form-control" name='bk_id' required id='bk_id'>
              </div>
            </div>
            <div class="col col-sm-6">
              <div class="form-group">
        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title" style='color:#012F5C;'>List of Brokers</h3>
                  ...
                  @foreach ($brokers as $a)
                    @if ($a->active==1)
                      ...
                      <td style="text-align:center;">
                        <a href="./brokers/{{$a->id}}/edit" class="btn btn-warning" style="color: white" title='Edit'><i class="fa fa-edit"></i></a>
                        @if ($a->active==1)
