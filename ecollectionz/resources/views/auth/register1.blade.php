...
<!DOCTYPE html>
<html>
 @include('inc.header_register')
<body>
  {!! csrf_field() !!}
<div class="container">
@include('inc.messages')
	<div class="d-flex justify-content-center h-100">
		<div class="card" style="height: 730px !important;">
      <img src="{{ asset('img/logo.png') }}" width="40%" style="margin:2% 0 0 3%;" /><br>
          ...
          <div class="input-group form-group">
            ...
            <input id="email" type="email" class="form-control"  name="email" value="{{ old('email') }}" required autofocus placeholder="Email Addresss">
					</div>
					<div class="input-group form-group">
						<div class="input-group-prepend">
          ...
          <div class="input-group form-group">
            ...
            <input id="phone" type="tel" class="form-control"
              name="phone"  required  style="width: 107% !important;margin-left: 3%;">
          </div>
            <div class="input-group form-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"><i class="fas fa-map-marked"></i></span>
                </div>
                <select id="country" name="country" class="form-control select22">
            ...
            <label style="color: #F5BE20 !important;">
                <input type="checkbox" required> I agree to the <a href="#">terms</a>
            </label>
            <div class="form-group">
                <input type="submit" value="Register" style="font-family: Poppins-SemiBold, sans-serif; width: 100%;"
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center">
					<div class="checkbox" style="color:white !important;">

          </div>

        </div>
         <a href="./login" class="text-center " style="color:#FFC312;">I already have a membership</a>
      </div>
      <br/>
