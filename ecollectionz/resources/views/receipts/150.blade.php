...
<div class="container-fluid">
   <table border="0">
    ...
    <div style="border: 1px solid black; padding: 10px;">
        ...
        <br>
        <table  style="width: 70%; font-weight: bold; margin-left: 2px;">
            <tr>
                <td>{{$stamp}}</td>
                <td><img class="img2" src="{{ asset('img/rstamp.png') }}"  width="180px"></td>
                <td><img  src="{{ asset('img/collect.jpg') }}" style="width: 80px;  margin-right: 125px;"></td>
            </tr>
        </table>
        <br>
