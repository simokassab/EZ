...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-light border-bottom" style="background-color:#012F5C !important;">
    ...
    <a href="{{ route('corporates.profile') }}"  class="btn btn-warning " >
                    Profile
                  </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav  nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li  class='nav-item' >
            <a href="{{ URL::route('corporates.dashboard') }}" class='nav-link'>
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li  class='nav-item' >
                <a href="{{ URL::route('corporates.clients') }}" class='nav-link'>
                    <i class="nav-icon fas fa-plus"></i>
                    <p>Clients</p>
                </a>
            </li>
            <li  class='nav-item' >
                <a href="{{ URL::route('corporate.allpolicies') }}" class='nav-link'>
          ...
          <li  class='nav-item' >
            <a href="{{ URL::route('corporates.requests') }}" class='nav-link'>
              <i class="nav-icon fas fa-comments"></i>
              <p>Policies Requests</p>
            </a>
          </li>
        <a href="{{ route('corporate.logout') }}"  onclick="event.preventDefault();
        document.getElementById('logout-form').submit();" class="btn btn-danger " style="color:white;">
          <i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp;&nbsp;Logout
        </a>
        <form id="logout-form" action="{{ route('corporate.logout') }}" method="POST" style="display: none;">
            {{ csrf_field() }}
        </form>
        </ul>
      </nav>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2019 <a href="#">Ecollectz.online</a>.</strong>
    All rights reserved.
...
;
  ...
  $('input[type="checkbox"].flat-red, input[type="radio"].flat-red').iCheck({
    ...
    $(".clicked").click(function() {
        var id = $(this).attr("id");
        location.href = "./corporate/"+id+"/status";
    });
